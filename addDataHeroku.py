...
url = 'http://digitalcollege.herokuapp.com/myapi/student/'
url2 = 'http://digitalcollege.herokuapp.com/myapi/addstudentaccount/'
...
url = 'http://digitalcollege.herokuapp.com/myapi/teacher/'
url2 = 'http://digitalcollege.herokuapp.com/myapi/addteacheraccount/'	
listOfTeacherIDs = ['Ricky_Schlum','Karwa_EY']
listOfTeacherNames = ['Ricky Lakhar', 'Chaitanya Karwa']
listOfEmails = ['Ricky@gmail.com','Karwa@gmail.com']
listOfPhoneNumbers = ['8504005493','9031702359']
for i in range(2):
	r = requests.post(url2,headers=headers, data={'teacherID':listOfTeacherIDs[i],'teacherFullName':listOfTeacherNames[i],'teacherPhoneNumber':listOfPhoneNumbers[i],'teacherEmailID':listOfEmails[i]})
	print r.text
	r = requests.post(url,headers=headers, data={'teacherID':listOfTeacherIDs[i],'teacherFullName':listOfTeacherNames[i]})
	print r.text

url = 'http://digitalcollege.herokuapp.com/myapi/subject/'	
url2 = 'http://digitalcollege.herokuapp.com/myapi/subjectcomponents/'
